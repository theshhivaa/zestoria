    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                >
          // A 48-hour deep dive into the neural architecture of the coming age. <br />
                    Secure your Node. Define the Grid.
                </motion.p>
                ...
                >
                    <button className="group relative px-8 py-4 bg-transparent border border-neon-green hover:bg-neon-green/10 transition-all duration-300">
                        ...
                        <span className="font-bold text-neon-green uppercase tracking-[0.1em] text-sm">Sync Connection</span>
                    </button>

                    <button className="group px-8 py-4 bg-transparent border border-white/20 hover:border-white/50 transition-all duration-300">
                        <span className="font-bold text-white uppercase tracking-[0.1em] text-sm group-hover:text-neon-green transition-colors">Download Protocols</span>
                    </button>
                </motion.div>
            </div>
